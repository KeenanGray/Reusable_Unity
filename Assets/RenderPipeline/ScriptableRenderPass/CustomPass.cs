...
public class CustomPass : ScriptableRenderPass
{
    ...
    const string ProfilerTag = "Custom Pass";

    // We will store our pass settings in this variable.
    CustomFeature.PassSettings passSettings;
    ...
    public CustomPass(CustomFeature.PassSettings passSettings)
    {
        ...
        if(material == null) material = passSettings.material;

        // Set any material properties based on our pass settings.
        material.SetColor(color, passSettings.color);
        material.SetFloat(cutoff, passSettings.cutoff);
    }

    // Gets called by the renderer before executing the pass.
    // Can be used to configure render targets and their clearing state.s
